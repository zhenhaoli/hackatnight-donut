...
Copy api-v1-1.0.0.jar from the `target` folder and all other libraries located in `target/lib` to your project's lib folder.
...
// create a client
final ConnecteddriveapiClient client = factory.build(ConnecteddriveapiClient.class);

// Invoke your rootGet method
Empty  output = client.rootGet();
